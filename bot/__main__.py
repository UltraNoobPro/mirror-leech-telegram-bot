...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Join", "https://t.me/StarterLeech")
    buttons.buildbutton("My Master", "https://t.me/Harshu_xD")
...
'''
        ...
        sendMarkup('Join This Group To Use Me!\n\nPresented By 🤴 нαяѕнυ_х∂', context.bot, update, reply_markup)
    ...
    if ospath.isfile(".restartmsg"):
        ...
        try:
            for i in AUTHORIZED_CHATS:
                if str(i).startswith('-'):
                    bot.sendMessage(chat_id=i, text="<b>Bot Restarted!\n\n📝 Note: Bot has been Restarted! All Downloding Request has been cancelled! so you need to Mirror again if bot Restarted while you are mirroring.\n\n💡BOT WILL RESTART EVERY 24HR</b>", parse_mode=ParseMode.HTML)
